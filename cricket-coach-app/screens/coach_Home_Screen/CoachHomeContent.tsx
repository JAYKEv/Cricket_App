...
const HomeContent = () => {
  ...
  const handleSaveEvent = () => {
    ...
    if (editingEvent) {
      ...
      const updatedEvents = events.map(e => 
        e.id === editingEvent.id ? { ...e, ...newEvent } as Event : e
      );
      setEvents(updatedEvents);
  ...
  return (
    ...
    >
      ...
      {/* Upcoming Events Preview - Now with edit functionality */}
      ...
      <Modal visible={isEventModalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.eventForm}>
              ...
              <View style={styles.formGroup}>
                ...
                {showTimePicker && (
                  <DateTimePicker
                    value={new Date(`1970-01-01T${newEvent.time}:00`)}
                    mode="time"
                    display="default"
